...
#define PS_MEAS_RATE_25    25 
#define PS_MEAS_RATE_50    50
#define PS_MEAS_RATE_100   100
#define PS_MEAS_RATE_200   200
#define PS_MEAS_RATE_400   400

#define ALS_GAIN_1         1
#define ALS_GAIN_3         3
#define ALS_GAIN_6         6
#define ALS_GAIN_9         9
#define ALS_GAIN_18        18

#define CCT_M_DEFAULT_VALE 6914
#define CCT_N_DEFAULT_VALE 1735

#define CCT_COMP_H_VALUE   913
#define CCT_COMP_A_VALUE   1010
#define CCT_COMP_D_VALUE   1076

#define LUX_P_VALUE        746
#define LUX_Q_VALUE        714
#define LUX_R_VALUE        641

#define AVAGO_COFF_10      10
#define AVAGO_COFF_18      18
#define AVAGO_COFF_27      27

#define LUX_ARR_10         10
#define LUX_ARR_20         20
#define LUX_ARR_30         30
#define LUX_ARR_50         50
#define LUX_ARR_75         75
#define LUX_ARR_200        200
#define LUX_ARR_400        400
#define LUX_ARR_800        800
#define LUX_ARR_1500       1500
#define LUX_ARR_3000       3000
#define LUX_ARR_5000       5000
#define LUX_ARR_8000       8000
#define LUX_ARR_10000      10000

#define POWER_DELAY_FLAG   1
#define CALIB_DEFAULT_DATA 1000

#define ALS_DATION_MAX     (9000*1000)
#define DEBUG_MASK         1
#define APDS9251_ERR_LOG   0
#define APDS9251_INFO_LOG  1
#define APDS9251_FLOW_LOG  2

#define TP_MODULE_DEF_ID   (0x55)
#define ALS_CALIBRATE_LOOP       6
#define APDS_ALS_100             100
#define APDS_ALS_1000            1000
#define APDS_STATE_ERR              (-1)
#define CALIBRATE_DATA_LEN          6
#define I2C_DATA_ARR_SIZE           3
#define REG_ADDR_STR_LEN            10
#define I2C_DATA_LEN                12
#define APDS_BUF_SIZE               32
#define APDS_BUF_512                512

#define I2C_DATA_RIGHT_SHIFT_0X1    (0x1)
#define I2C_DATA_RIGHT_SHIFT_0X8    (0x8)
#define I2C_DATA_RIGHT_SHIFT_0X1B   (0x1B)
#define I2C_DATA_LEFT_SHIFT_0X3     (0x3)
#define I2C_DATA_LEFT_SHIFT_0X9     (0x9)
#define I2C_DATA_LEFT_SHIFT_0X20    (0x20)
#define I2C_DATA_LEFT_SHIFT_8       8
#define I2C_DATA_LEFT_SHIFT_16      16
#define I2C_DATA_RIGHT_SHIFT_16     16
#define I2C_DATA_RIGHT_SHIFT_24     24
#define APDS_ALS_INVALID            (-1)
#define APDS_ALS_1                  1
#define APDS_ALS_10                 10
#define APDS_ALS_10000              10000
#define APDS_ALS_30000              30000
#define APDS_ALS_1000000            1000000
#define APDS_ALS_POLL_COUNT         5
#define APDS_ALS_2                  2
#define APDS_ALS_4                  4
#define APDS_ALS_16                 16
#define APDS_ALS_25                 25
#define APDS_ALS_50                 50
#define APDS_ALS_100                100
#define APDS_ALS_200                200
#define APDS_ALS_0XB2               (0xb2)
#define APDS_MSLEEP_20              20
#define APDS_ALS_DISANBLE           0
#define APDS_ALS_EANBLE             1
#define APDS_DEBUG_MASK             1
#define APDS_VALID_MASK_0XFF        (0xff)
#define APDS_VALID_MASK_0XFFFF      (0xffff)

#define APDS_POLL_DELAY_TIME        200
#define APDS_PREV_LUX_VALUE         300
#define APDS_REG_VALUE_0X50         (0x50)
#define APDS_VAL_1             1
#define APDS_VAL_3             3
#define APDS_VAL_6             6
#define APDS_VAL_10            10
#define APDS_VAL_100           100
#define APDS_VAL_512           512
#define APDS_VAL_1000          1000

static unsigned short apds9251_als_meas_rate_tb[] = {PS_MEAS_RATE_25, PS_MEAS_RATE_50, PS_MEAS_RATE_100, PS_MEAS_RATE_200, PS_MEAS_RATE_400};
static unsigned char apds9251_als_gain_tb[] = { ALS_GAIN_1, ALS_GAIN_3, ALS_GAIN_6, ALS_GAIN_9, ALS_GAIN_18 };
static long CCT_M = CCT_M_DEFAULT_VALE;
static long CCT_N = CCT_N_DEFAULT_VALE;
static long cct_compensator_H = CCT_COMP_H_VALUE;
static long cct_compensator_A = CCT_COMP_A_VALUE;
static long cct_compensator_D = CCT_COMP_D_VALUE;
static long LUX_P = LUX_P_VALUE;
static long LUX_Q = LUX_Q_VALUE;
static long LUX_R = LUX_R_VALUE;
static long avago_cofficient[APDS_VAL_3] = {AVAGO_COFF_27, AVAGO_COFF_18, AVAGO_COFF_10};
/*Ambient light array of values*/
static unsigned int  lux_arr[] = {LUX_ARR_10, LUX_ARR_20,LUX_ARR_30,LUX_ARR_50,
                                  LUX_ARR_75,LUX_ARR_200,LUX_ARR_400,LUX_ARR_800,
                                  LUX_ARR_1500,LUX_ARR_3000,LUX_ARR_5000,LUX_ARR_8000,LUX_ARR_10000};
...
static int apds_power_delay_flag = POWER_DELAY_FLAG;   /* 1 not always on ,0 always on*/
static int apds9251_als_calibrate_flag = 0;//uint8
static int apds9251_als_calibrate_count = 0;//uint8
static long apds9251_calibrate_total_data[APDS_VAL_6] = {0};//32
static long apds9251_calibrate_average_data[APDS_VAL_6] = {0};//uint16

static int apds9251_auto_light_open_flag = 0;
static long apds9251_calibrate_object_data_from_kernel[APDS_VAL_6] = {CALIB_DEFAULT_DATA,CALIB_DEFAULT_DATA,CALIB_DEFAULT_DATA,
                                                             CALIB_DEFAULT_DATA,CALIB_DEFAULT_DATA,CALIB_DEFAULT_DATA};//uint16
static long apds9251_als_offset[APDS_VAL_6] = {CALIB_DEFAULT_DATA, CALIB_DEFAULT_DATA, CALIB_DEFAULT_DATA,
                                                             CALIB_DEFAULT_DATA, CALIB_DEFAULT_DATA, CALIB_DEFAULT_DATA};//uint16

static long als_ratio_max = ALS_DATION_MAX;
static long als_ratio_min = 0;

#define APDS9251_ALS_CALIBRATE_COUNT 6
#define ADPS9251_USE_CALIBRATE_PARA 0

static int rgb_apds9251_debug_mask= DEBUG_MASK;
module_param_named(rgb_apds9251_debug, rgb_apds9251_debug_mask, int, S_IRUGO | S_IWUSR | S_IWGRP);

#define APDS9251_ERR(x...) do {\
    if (rgb_apds9251_debug_mask >=APDS9251_ERR_LOG) \
        printk(KERN_ERR x);\
    } while (0)

#define APDS9251_INFO(x...) do {\
    if (rgb_apds9251_debug_mask >=APDS9251_INFO_LOG) \
        printk(KERN_ERR x);\
    } while (0)
...
struct apds9251_lux_cal_parameter{
	...
	long lux_q;
	long lux_r;
	long avago_cofficient[APDS_VAL_3];
	long red_mmi;
	long green_mmi;
	long blue_mmi;
	long clear_mmi;
...
static struct apds9251_tp_lx_cal_parameter apds9251_tp_module_parameter[MODULE_MANUFACTURE_NUMBER] = {
    {.tp_module_id = TP_MODULE_DEF_ID},{.tp_module_id = TP_MODULE_DEF_ID},{.tp_module_id = TP_MODULE_DEF_ID},
    {.tp_module_id = TP_MODULE_DEF_ID},{.tp_module_id = TP_MODULE_DEF_ID},{.tp_module_id = TP_MODULE_DEF_ID}};
...
static struct sensors_classdev sensors_light_cdev = {
	...
	.resolution = "0.0125",
	.sensor_power = "0.20",
	.min_delay = APDS_VAL_1000, /* in microseconds */
	.fifo_reserved_event_count = 0,
	.fifo_max_event_count = 0,
	.enabled = 0,
	.delay_msec = APDS_VAL_100,
	.sensors_enable = NULL,
...
static int apds9251_i2c_exception_status(struct rgb_apds9251_data *data)
{
	...
	excep->vdd_mv = regulator_get_voltage(data->vdd)/APDS_VAL_1000;
	if(excep->vdd_mv < 0){
		APDS9251_ERR("%s,line %d:regulator_get_voltage vdd failed\n",__func__,__LINE__);
	}

	excep->vio_mv = regulator_get_voltage(data->vio)/APDS_VAL_1000;
	if(excep->vio_mv < 0){
...
static int apds9251_dsm_init(struct rgb_apds9251_data *data)
{
	...
	data->als_test_exception.reg_buf = kzalloc(APDS_VAL_512, GFP_KERNEL);
						...
						const char *buf, size_t count)
{
	...
	if (strict_strtol(buf, APDS_VAL_10, &mode))
			return -EINVAL;
...
{
	int i = 0;
	char reg_buf[APDS9251_REG_LEN] = {0,};
	u8 reg = 0;
	struct i2c_client *client = NULL;
...
static int LuxCalculation(struct i2c_client *client)
{
	...
	{
		ir_r_ratio = data->rgb_data.ir*APDS_ALS_100/data->rgb_data.red;
		b_r_ratio = data->rgb_data.blue*APDS_ALS_1000/data->rgb_data.red;
	}
	cct = div_s64(CCT_M*b_r_ratio, APDS_ALS_1000) + CCT_N;
	
	if (ir_r_ratio > avago_cofficient[0]){
		cct = div_s64(cct_compensator_H * cct, APDS_ALS_1000);
		...
		cct = div_s64(cct_compensator_A * cct, APDS_ALS_1000);
		lux = data->rgb_data.green*LUX_R/((apds9251_als_meas_rate_tb[data->als_res_index])*apds9251_als_gain_tb[4]);
	}else if (ir_r_ratio > avago_cofficient[2]){
		cct = div_s64(cct_compensator_D * cct, APDS_ALS_1000);
...
static void apds9251_als_calibrate(unsigned int *raw_data)//uint16
{
	...
	if(apds9251_als_calibrate_count < APDS9251_ALS_CALIBRATE_COUNT) 
	{
		...
		for(i = 0;i < ALS_CALIBRATE_LOOP; i++){
	...
	else
	{
		for(i = 0;i < ALS_CALIBRATE_LOOP; i++)
		{
			if(apds9251_calibrate_total_data[i] < APDS9251_ALS_CALIBRATE_COUNT)
			{
				...
				apds9251_als_offset[0]=APDS_ALS_1000;
				apds9251_als_offset[1]=APDS_ALS_1000;
				apds9251_als_offset[2]=APDS_ALS_1000;
				apds9251_als_offset[3]=APDS_ALS_1000;
				apds9251_als_offset[4]=APDS_ALS_1000;
				apds9251_als_offset[5]=APDS_ALS_1000;
				status = APDS_STATE_ERR;
				break;
			}
			else
			{
				...
				apds9251_als_offset[i]=(apds9251_calibrate_object_data_from_kernel[i]*APDS_ALS_1000)/apds9251_calibrate_average_data[i];
...
{
	struct rgb_apds9251_data *data = NULL;
	unsigned char i2c_data[I2C_DATA_LEN] = {0,};
	int status = 0;
	int i = 0;
	unsigned int calibrate_data[CALIBRATE_DATA_LEN] = {0};
	...
	data->rgb_data.ir = (i2c_data[2] << I2C_DATA_LEFT_SHIFT_16) | (i2c_data[1] << I2C_DATA_LEFT_SHIFT_8) | i2c_data[0];
	data->rgb_data.green = (i2c_data[5] << I2C_DATA_LEFT_SHIFT_16) | (i2c_data[4] << I2C_DATA_LEFT_SHIFT_8) | i2c_data[3];
	data->rgb_data.blue = (i2c_data[8] << I2C_DATA_LEFT_SHIFT_16) | (i2c_data[7] << I2C_DATA_LEFT_SHIFT_8) | i2c_data[6];
	data->rgb_data.red = (i2c_data[11] << I2C_DATA_LEFT_SHIFT_16) | (i2c_data[10] << I2C_DATA_LEFT_SHIFT_8) | i2c_data[9];
	...
	data->rgb_data.red=apds9251_als_offset[0]*data->rgb_data.red/APDS_ALS_1000;
	data->rgb_data.green=apds9251_als_offset[1]*data->rgb_data.green/APDS_ALS_1000;
	data->rgb_data.blue=apds9251_als_offset[2]*data->rgb_data.blue/APDS_ALS_1000;
	data->rgb_data.ir=apds9251_als_offset[3]*data->rgb_data.ir/APDS_ALS_1000;
	//data->rgb_data.lx=apds9251_als_offset[3]*data->rgb_data.lx/APDS_ALS_1000;
	data->rgb_data.cct=apds9251_als_offset[5]*data->rgb_data.cct/APDS_ALS_1000;
#endif
	...
	// report to HAL
	data->rgb_data.lx = (data->rgb_data.lx>APDS_ALS_30000) ? APDS_ALS_30000 : data->rgb_data.lx;
	data->rgb_data.cct = (data->rgb_data.cct<APDS_ALS_10000) ? data->rgb_data.cct : APDS_ALS_10000;
	if( apds_als_polling_count < APDS_ALS_POLL_COUNT )
	{
		if(data->rgb_data.lx == APDS9251_LUX_MAX)
		{
			data->rgb_data.lx = data->rgb_data.lx - apds_als_polling_count%APDS_ALS_2;
		}
		else
		{
			data->rgb_data.lx = data->rgb_data.lx + apds_als_polling_count%APDS_ALS_2;
...
static void rgb_apds9251_als_polling_work_handler(struct work_struct *work)
{
	...
	ret = hrtimer_start(&data->timer, ktime_set(0, data->als_poll_delay * APDS_ALS_1000000), HRTIMER_MODE_REL);
	if (ret != 0) {
...
static int rgb_apds9251_enable_als_sensor(struct i2c_client *client, int val)
{
	...
	if (val == APDS_ALS_EANBLE) {
		...
		if(data->enable_als_sensor == APDS_ALS_EANBLE){
		...
		unsigned int enable)
{
	...
	if ((enable != APDS_ALS_DISANBLE) && (enable != APDS_ALS_EANBLE)) {
	...
	if(enable == APDS_ALS_DISANBLE)
	{
		rgb_apds9251_enable_als_sensor(data->client, enable);

		if(rgb_apds9251_debug_mask >= APDS_DEBUG_MASK){
		...
		unsigned int val)
{
	...
	if (val <= APDS_ALS_25){
		data->als_poll_delay = APDS_ALS_25;
	...
	}else if (val <= APDS_ALS_50){
		data->als_poll_delay = APDS_ALS_50;
	...
	}else if (val <= APDS_ALS_100){
		data->als_poll_delay = APDS_ALS_100;
	...
	}else if (val <= APDS_ALS_200){
		data->als_poll_delay = APDS_ALS_200;
			...
			struct device_attribute *attr, char *buf)
{
	struct i2c_client *client = NULL;
	struct rgb_apds9251_data *data = NULL;
	unsigned char i2c_data[I2C_DATA_ARR_SIZE] = {0};
	...
	i2c_smbus_read_i2c_block_data(client, APDS9251_DD_IR_DATA_ADDR, I2C_DATA_ARR_SIZE, (unsigned char*)i2c_data);
	
	data->rgb_data.red = (((int)i2c_data[2] << I2C_DATA_LEFT_SHIFT_16) | ((short)i2c_data[1] << I2C_DATA_LEFT_SHIFT_8) | i2c_data[0]);

	return snprintf(buf,APDS_BUF_SIZE,"%d\n", data->rgb_data.ir);
}
			...
			struct device_attribute *attr, char *buf)
{
	...
	i2c_smbus_read_i2c_block_data(client, APDS9251_DD_RED_DATA_ADDR, I2C_DATA_ARR_SIZE, (unsigned char*)i2c_data);
			...
			struct device_attribute *attr, char *buf)
{
	...
	i2c_smbus_read_i2c_block_data(client, APDS9251_DD_GREEN_DATA_ADDR, I2C_DATA_ARR_SIZE, (unsigned char*)i2c_data);
	
	data->rgb_data.green= (((int)i2c_data[2] << I2C_DATA_LEFT_SHIFT_16) | ((short)i2c_data[1] << I2C_DATA_LEFT_SHIFT_8) | i2c_data[0]);
			...
			struct device_attribute *attr, char *buf)
{
	...
	i2c_smbus_read_i2c_block_data(client, APDS9251_DD_BLUE_DATA_ADDR, I2C_DATA_ARR_SIZE, (unsigned char*)i2c_data);
	
	data->rgb_data.blue= (((int)i2c_data[2] << I2C_DATA_LEFT_SHIFT_16) | ((short)i2c_data[1] << I2C_DATA_LEFT_SHIFT_8) | i2c_data[0]);
...
{
	struct i2c_client *client = NULL;
	int val_len_max = APDS_ALS_4;
	char* input_str = NULL;
	char reg_addr_str[REG_ADDR_STR_LEN] = {'\0'};
	char reg_val_str[REG_ADDR_STR_LEN] = {'\0'};
	long reg_addr = 0;
	long reg_val = 0;
	int addr_lenth = 0;
	int value_lenth = 0;
	...
	snprintf(input_str, REG_ADDR_STR_LEN,"%s", buf);
	...
	ret = kstrtol(reg_addr_str,APDS_ALS_16,&reg_addr);
	if(ret)
		goto parse_fail_exit;

	ret = kstrtol(reg_val_str,APDS_ALS_16,&reg_val);
	if(ret)
		goto parse_fail_exit;
			...
			struct device_attribute *attr, char *buf)
{
	...
	for(i = 0; i < APDS9251_REG_LEN; i++ )
	{
		if ((i >= I2C_DATA_RIGHT_SHIFT_0X1) && (i <= I2C_DATA_LEFT_SHIFT_0X3))
			continue;
		if ((i >= I2C_DATA_RIGHT_SHIFT_0X8) && (i <= I2C_DATA_LEFT_SHIFT_0X9))
			continue;
		if ((i >= I2C_DATA_RIGHT_SHIFT_0X1B) && (i <= I2C_DATA_LEFT_SHIFT_0X20))
			continue;
	...
	return snprintf(buf,APDS_BUF_512,"reg[0x0,0x04~0x7,0x0a~0x0e]=0x%2x, 0x%2x, 0x%2x, 0x%2x, 0x%2x, 0x%2x, 0x%2x, 0x%2x, 0x%2x, 0x%2x\n"
						...
						const char *buf, size_t count)
{
	...
	valid_flag = val & APDS_VALID_MASK_0XFFFF;
	pdata->panel_id = (val >> I2C_DATA_RIGHT_SHIFT_16) & APDS_VALID_MASK_0XFF;
	pdata->tp_color = (val >> I2C_DATA_RIGHT_SHIFT_24) & APDS_VALID_MASK_0XFF;
				...
				struct device_attribute *attr, const char *buf, size_t count)
{
	...
	val = simple_strtoul(buf, NULL, APDS_ALS_10);
	client = to_i2c_client(dev);
	if (NULL == client) {
		APDS9251_ERR("%s,line %d: client is NULL!\n",__func__,__LINE__);
		return -EINVAL;
						...
						const char *buf, size_t count)
{
	...
	ret = sscanf(buf, "%ld %ld %ld %ld %ld %ld %ld",&x0, &x1, &x2, &x3, &x4, &x5, &x6);
 	...
 	if(x0 == APDS_ALS_1)
 	{
		...
		if(APDS_ALS_1 != data->enable_als_sensor)
		{
			rgb_apds9251_enable_als_sensor(data->client, APDS_ALS_1);
		}
		else
		{
			apds9251_auto_light_open_flag = APDS_ALS_1;   //auto light open
		}
 	}
 	else if (x0 == 0)
 	{
		if(APDS_ALS_1 != apds9251_auto_light_open_flag)     //auto light close
		{
...
static void rgb_apds9251_parameter_init(struct rgb_apds9251_data *data)
{
	...
	data->als_poll_delay = APDS_POLL_DELAY_TIME;
	data->als_prev_lux = APDS_PREV_LUX_VALUE;
	//100ms conversion time
	data->als_res_index = APDS9251_DD_ALS_RES_18BIT;
	//18x GAIN
	data->als_gain_index = APDS9251_DD_ALS_GAIN_18X;
	pdata->panel_id = APDS_ALS_INVALID;
	pdata->tp_color = APDS_ALS_INVALID;
}
...
static int rgb_apds9251_input_init(struct rgb_apds9251_data *data)
{
	...
	input_set_abs_params(data->input_dev_als, ABS_MISC, 0, APDS_ALS_10000, 0, 0);
...
enable_delay:
	if(APDS_ALS_1 == apds_power_delay_flag)
	{
		msleep(APDS_ALS_10);
	}
		...
		struct rgb_apds9251_platform_data *pdata)
{
	...
	if (rc) {
		...
		apds_power_delay_flag = APDS_ALS_1;
	}
	else {
	...
	for(i=0; i<tp_moudle_count; i++){
		...
		for(index = 0; index < array_len; index++){
			...
			ptr[index]  = simple_strtol(raw_data0_dts, NULL, APDS_ALS_10);
...
#ifdef CONFIG_HUAWEI_DEV_DETECT
	err = set_hw_dev_detect_result(DEV_DETECT_L_SENSOR);
	if (!err)
	{
		APDS9251_ERR("%s: set_hw_dev_detect_result fail.\n", __func__);
	}
#endif
	if (pdata->power_on)
